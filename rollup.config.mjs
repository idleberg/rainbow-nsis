...
const injector = entryCodeInjector({
  transformer: code => {
    ...
    const NSIS_KEYWORDS = [
      ...
      'Call', 'CallInstDLL', 'Caption', 'ChangeUI', 'CheckBitmap', 'ClearErrors', 'CompletedText', 'ComponentText', 'CopyFiles', 'CPU', 'CRCCheck', 'CreateDirectory', 'CreateFont', 'CreateShortCut',
      ...
      'GetCurInstType', 'GetCurrentAddress', 'GetDlgItem', 'GetDLLVersion', 'GetDLLVersionLocal', 'GetErrorLevel', 'GetFileTime', 'GetFileTimeLocal', 'GetFullPathName', 'GetFunctionAddress', 'GetInstDirError', 'GetKnownFolderPath', 'GetLabelAddress', 'GetRegView', 'GetShellVarContext', 'GetTempFileName', 'GetWinVer', 'Goto',
      'HideWindow',
      'Icon', 'IfAbort', 'IfAltRegView', 'IfErrors', 'IfFileExists', 'IfRebootFlag', 'IfRtlLanguage', 'IfShellVarContextAll', 'IfSilent', 'InitPluginsDir', 'InstallButtonText', 'InstallColors', 'InstallDir', 'InstallDirRegKey', 'InstProgressFlags', 'InstType', 'InstTypeGetText', 'InstTypeSetText', 'Int64Cmp', 'Int64CmpU', 'Int64Fmt', 'IntCmp', 'IntCmpU', 'IntFmt', 'IntOp', 'IntPtrCmp', 'IntPtrCmpU', 'IntPtrOp', 'IsWindow',
      ...
      'ManifestAppendCustomString', 'ManifestDisableWindowFiltering', 'ManifestDPIAware', 'ManifestDPIAwareness', 'ManifestGdiScaling', 'ManifestLongPathAware', 'ManifestMaxVersionTested', 'ManifestSupportedOS', 'MessageBox', 'MiscButtonText',
      'Name', 'Nop',
      'OutFile',
      'Page', 'PageCallbacks', 'PEAddResource', 'PEDllCharacteristics', 'PERemoveResource', 'PESubsysVer', 'Pop', 'Push',
      'Quit',
      'ReadEnvStr', 'ReadINIStr', 'ReadMemory', 'ReadRegDWORD', 'ReadRegStr', 'Reboot', 'RegDLL', 'Rename', 'RequestExecutionLevel', 'ReserveFile', 'Return', 'RMDir',
      ...
      'Target',
      'Unicode', 'UnsafeStrCpy', 'UninstallButtonText', 'UninstallCaption', 'UninstallIcon', 'UninstallSubCaption', 'UninstallText', 'UninstPage', 'UnRegDLL',
    ...
    const NSIS_PROPERTIES = [
      ...
      'hide', 'highest', 'HKCC', 'HKCR', 'HKCR32', 'HKCR64', 'HKCU', 'HKCU32', 'HKCU64', 'HKDD', 'HKEY_CLASSES_ROOT', 'HKEY_CURRENT_CONFIG', 'HKEY_CURRENT_USER', 'HKEY_DYN_DATA', 'HKEY_LOCAL_MACHINE', 'HKEY_PERFORMANCE_DATA', 'HKEY_USERS', 'HKLM', 'HKLM32', 'HKLM64', 'HKPD', 'HKU',
      'IDABORT', 'IDCANCEL', 'IDIGNORE', 'IDNO', 'IDOK', 'IDRETRY', 'IDYES', 'ifdiff', 'ifnewer', 'instfiles',
      'lastused', 'leave', 'left', 'license', 'listonly', 'lzma',
      'MB_ABORTRETRYIGNORE', 'MB_DEFBUTTON1', 'MB_DEFBUTTON2', 'MB_DEFBUTTON3', 'MB_DEFBUTTON4', 'MB_ICONEXCLAMATION', 'MB_ICONINFORMATION', 'MB_ICONQUESTION', 'MB_ICONSTOP', 'MB_OK', 'MB_OKCANCEL', 'MB_RETRYCANCEL', 'MB_RIGHT', 'MB_RTLREADING', 'MB_SETFOREGROUND', 'MB_TOPMOST', 'MB_USERICON', 'MB_YESNO', 'MB_YESNOCANCEL',
      'nevershow', 'none', 'normal', 'notset',
      'off', 'OFFLINE', 'on', 'open',
      'print',
      'READONLY', 'right',
      'SHCTX', 'SHELL_CONTEXT', 'show', 'silent', 'silentlog', 'smooth', 'SW_HIDE', 'SW_SHOW', 'SW_SHOWMAXIMIZED', 'SW_SHOWMINIMIZED', 'SW_SHOWNORMAL', 'SYSTEM',
