(function () {
    ...
    Rainbow.extend('nsis', [
        ...
        },
        {
            ...
            'pattern': /!(?:a(?:dd(?:includedir|plugindir)|ppendfile|ssert)|cd|de(?:fine|lfile)|e(?:cho|rror|xecute)|finalize|get(?:dllversion|tlbversion)|in(?:clude|sertmacro)|makensis|p(?:ackhdr|ragma)|s(?:earch(?:parse|replace)|ystem)|tempfile|un(?:def|instfinalize)|verbose|warning)(?=\(|\b)/g
        },
        {
